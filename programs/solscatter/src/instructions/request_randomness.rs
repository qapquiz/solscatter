...
pub struct RequestRanmdomness<'info> {
    #[account(
        mut,
        seeds = [
            STATE_SEED, 
    ...
    /// CHECK: this is vrf related account
...
pub fn handler(ctx: Context<RequestRanmdomness>, params: RequestRandomnessParams) -> Result<()> {
